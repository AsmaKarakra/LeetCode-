...
public class Playground {
    ...
    public static void main(String[] args) {
         ...
         * Problem Statement:
         Write a function, treeMinValue, that takes in a pointer
        ...
        int result = treeMinVal(rootNode);
    ...
    public static int treeMinVal(BST rootNode){
        ...
        while(treeQueue.size() > 0){
            ...
            minVal = Math.min(minVal, currentNode.value);
